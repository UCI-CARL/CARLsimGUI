...
#-----               GUI                  -----#
#----------------------------------------------#
HEADERS += src/gui/ExampleExptWidget.h
SOURCES += src/gui/ExampleExptWidget.cpp


#----------------------------------------------#
#-----              Managers              -----#
#----------------------------------------------#
HEADERS += src/managers/ExampleExptManager.h
SOURCES += src/managers/ExampleExptManager.cpp
