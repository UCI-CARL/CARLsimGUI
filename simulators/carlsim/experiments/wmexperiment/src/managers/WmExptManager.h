#ifndef MWEXPTMANAGER_H
#define WMEXPTMANAGER_H
...
namespace spikestream {
	...
	class WmExptManager: public SpikeStreamThread {
		Q_OBJECT
		...
		public:
			...
			//	QStringList starts, QStringList ends, 
		...
		private:
			...
			//Maze* maze; 
			WmExpCarlsimWrapper* expWrapper; // specialization 
			...
			////======================  METHODS  ======================
			void runExperiment1(); // Single State
			void runExperiment2(); // Start to Target State
			void runExperiment3(); // Random Walk through States
