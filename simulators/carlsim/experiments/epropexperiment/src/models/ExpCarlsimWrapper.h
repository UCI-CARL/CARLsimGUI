#ifndef EXPCARLSIMWRAPPER_H
#define EXPCARLSIMWRAPPER_H
...
//class spikestream::EpropExptManager;

class ExpCarlsimWrapper 
{
...
public:
	...
	ExpCarlsimWrapper(CarlsimWrapper* wrapper, carlsim_monitors::OatSpikeMonitor* monitor, Maze* maze, int grpId);

	virtual ~ExpCarlsimWrapper();
