...
AbstractSTDPFunction::AbstractSTDPFunction(){
	...
	defaultParameterMap["apply_stdp_interval"] = 1000;
	parameterInfoList.append(ParameterInfo("apply_stdp_interval", "Time in between each call to carlsim_apply_stdp.", ParameterInfo::UNSIGNED_INTEGER));
}
