...
StandardSTDPFunction::StandardSTDPFunction() : AbstractSTDPFunction() {
	...
	defaultParameterMap["apply_stdp_interval"] = 10;
	defaultParameterMap["reward"] = 0.01; 
	defaultParameterMap["A+"] = 0.25;	
	defaultParameterMap["A-"] = 0.375;	
	defaultParameterMap["T+"] = 13.0;
	defaultParameterMap["T-"] = 15.0;
	defaultParameterMap["min_excitatory_weight"] = 0.001;
	defaultParameterMap["max_excitatory_weight"] = 4.0; 
	defaultParameterMap["min_inhibitory_weight"] = -0.001;
	defaultParameterMap["max_inhibitory_weight"] = -0.5; 

	//Initialize current parameter map with default values
