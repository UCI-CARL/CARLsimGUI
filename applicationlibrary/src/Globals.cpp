...
//QString Globals::configFile = "spikestream.config";    --> cannnot be integrated --> singelton directly in class ConfigLoader
...
//void Globals::setConfigFile(QString config) {
//	configFile = config;
//}



SpikeStreamMainWindow* Globals::mainWindow = NULL;

SpikeStreamMainWindow* Globals::getMainWindow() { return mainWindow; }

void Globals::setMainWindow(SpikeStreamMainWindow* mainWindow) { Globals::mainWindow = mainWindow; };
