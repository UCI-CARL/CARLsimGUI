...
namespace spikestream {
	...
	class SPIKESTREAM_APP_LIB_EXPORT NetworkDisplay : public QObject {
		Q_OBJECT
		...
		public:
			...
			float getConnectionTransparency() { return connectionTransparency; }
			...
			unsigned getDelayRenderMode() { return delayRenderMode; }
			...
			void renderWeightSynapse();
			void renderWeightMiddle();
			void renderWeightEven();
			void disableDelayRender();
			void renderTempDelays();
			void renderCurrentDelays();
			...
			void setConnectionTransparency(float connectionTransparency);
			...
			void setContextNeuronID(unsigned int id);
			void handleContext(bool ctrlBtnDown = false, bool shftBtnDown = false);
		...
		signals:
			...
			void connectionGroupDisplayChanged();
		...
		private:
			...
			/*! Transparency of the connection. Should be between 0 and 1. */
			float connectionTransparency;
			...
			void checkDelayRenderFlag(unsigned int flag);
			...
			void setDelayRenderFlag(unsigned flag);
			void unsetDelayRenderFlag(unsigned flag);
	};
