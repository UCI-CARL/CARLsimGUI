...
class SPIKESTREAM_TEST_LIB_EXPORT TestDao : public QObject {
	Q_OBJECT
	...
	protected:
		...
		// CarlsimWrapper 
		unsigned int testNet3ID;
		unsigned int neurGrp31ID;
		unsigned int neurGrp32ID;
		unsigned int connGrp3132ID;
		QList<unsigned int> testConnIDList3;
		QList<unsigned int> testNeurIDList3;
		...
		void addTestNetwork3_CarlsimBasic();  
		...
		void resetTestNetwork3_CarlsimBasic(); 
