...
void Connection::print(){
   ...
   cout<<" toNeuronID="<<toNeuronID<<"; delay="<<delay << "; tempDelay=" << tempDelay <<"; weight="<<weight<<"; tempWeight="<<tempWeight<<endl;
}
